...
-- Define a "master key" as the Super/Windows button
local mainMod = "SUPER"

-- Binds for daily use software
...
-- Navigate and manipulate workspaces
for i = 1, 10 do
	local key = i % 10
...
-- Navigate and manipulate the special workspace
hl.bind(mainMod .. " + S", hl.dsp.workspace.toggle_special("magic"))
hl.bind(mainMod .. " + SHIFT + S", hl.dsp.window.move({ workspace = "special:magic" }))

-- Print and record screen
...
-- Special keys to control brightness
